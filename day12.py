...
def sum_nums(o, nums, val_to_exclude):
    if isinstance(o, dict):
        if val_to_exclude not in o.values():
            sum_nums(list(o.values()), nums, val_to_exclude)
    if isinstance(o, list):
        for i in o:
            sum_nums(i, nums, val_to_exclude)
    if isinstance(o, int):
        nums.append(o)

data = json.load(open("day12_input"))
